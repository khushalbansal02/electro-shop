# Electro Shop - Modern eCommerce Platform

> **Developed by Khushal**

A full-stack eCommerce platform built with Next.js, Nest.js, and MongoDB, featuring AI-powered product management and modern authentication. This project is developed and maintained by Khushal.
...
```bash
git clone https://github.com/khushalbansal02/electro-shop.git
```
...
## Author
- Khushal Bansal
- [GitHub](https://github.com/khushalbansal02)
